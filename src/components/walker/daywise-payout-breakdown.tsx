...
interface DayWisePayoutBreakdownProps {
  detail: PayoutDetail;
  title?: string;
  showTdsInfo?: boolean;
  feId?: string;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
        ...
        <div className="mb-6">
          {content}
          {/* No "Check day-wise records" message for day-wise details */}
        </div>
...
export function DayWisePayoutBreakdown({ detail, title, showTdsInfo = true, feId = "12345" }: DayWisePayoutBreakdownProps) {
  ...
  // Helper functions to generate modal content for Day-wise
  ...
  // Day-wise specific calculations - same logic but separate implementation
  ...
  const totalPayout = 23960; // Same total payout as billing cycle
      ...
      <Card className="card-elevated border-2 border-dashed" style={{backgroundColor: '#E3FEEF', borderColor: '#28C269'}}>
        ...
        <CardContent className="pt-0 space-y-2">
          ...
          <div className="flex items-center justify-between payout-total">
            ...
            <span style={{color: '#1F9A53', fontSize: '14px', fontWeight: 'bold'}}>₹540</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="card-elevated border-2 border-dashed" style={{backgroundColor: '#FFFAEB', borderColor: '#DC6803'}}>
        ...
        <CardContent className="pt-0 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="payout-content" style={{color: '#DC6803', fontSize: '14px', fontWeight: 'bold'}}>-₹200</span>
          </div>
          <hr className="payout-line" />
          <div className="flex items-center justify-between payout-total">
            <span>Total Deductions</span>
            <span style={{color: '#DC6803', fontSize: '14px', fontWeight: 'bold'}}>-₹200</span>
          </div>
        </CardContent>
      </Card>
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => openModal('TDS', <div className="space-y-3"><p className="text-sm text-gray-600">TDS information</p><p className="text-sm text-gray-600">Your FE ID - FE001234</p></div>)}
                  className="text-gray-400 hover:text-gray-600 transition-colors"
                >
                  <Info className="h-4 w-4" />
                </button>
      ...
      <Card className="card-elevated bg-gray-50">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="payout-content" style={{color: '#28C269', fontSize: '14px', fontWeight: 'bold'}}>₹540</span>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between payout-total">
            ...
            <span style={{fontSize: '14px', fontWeight: 'bold'}}>₹1135</span>
          </div>
        </CardContent>
      </Card>
